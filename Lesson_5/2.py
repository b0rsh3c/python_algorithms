...
def num_converter(in_nums=True, *args):
    '''Конвертация из 16 в 10 и наоборот.
    in_nums = True по умолчанию  конвертируем из 16 в 10(default) if you need convert from symbol to nums
    in_nums = False из в 10 в 16'''
